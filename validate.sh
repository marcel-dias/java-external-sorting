...
java -server -Xmx256m -Xms256m -XX:+TieredCompilation -Dfilename=$FILENAME -DnrWriterThreads=$NR_WRITER_THREADS -Doutput=$OUTPUT -DtempFilesDir=$TEMP_FILES_DIR -jar $jarfile validate
